...
namespace TimberV2.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentID,UserID,BlogID,Time,CommentBody")] Comment comment)
        {
            ...
            ViewBag.UserID = new SelectList(db.Users, "UserID", "UserEmail", comment.UserID);
            return View(comment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentID,UserID,BlogID,Time,CommentBody")] Comment comment)
        {
            if (ModelState.IsValid)
            {
